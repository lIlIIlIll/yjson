...
下面是 2026-09-09 七库对比第二批的 11 轮中位数，单位为 µs/op，越小越好。
测量使用提交 `987bc8a764771e8157a5b5c0c45c169f654d0b4f`。
**两批结果的每一行都至少有一个库的变异系数（CV）超过 5%，因此这些数字仅供查看，不能作为稳定的性能排名。**

完整样本、波动情况和环境见[2026-09-09 main 七库对比](docs/performance/results/2026-09-09-main-seven-library.md)。
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Address encode | 1.066 | 3.340 | 3.179 | 3.437 | 2.480 | 0.179 | 0.067 |
| Address decode | 1.505 | 2.439 | 3.512 | 3.446 | 2.032 | 0.325 | 0.073 |
| Person encode | 1.748 | 13.433 | 17.337 | 5.454 | 10.080 | 0.565 | 0.269 |
| Person decode | 8.201 | 21.760 | 26.771 | 20.265 | 15.443 | 1.114 | 0.421 |
| Large Array encode | 28.677 | 99.807 | 250.376 | 92.003 | 76.346 | 9.178 | 4.168 |
| Large Array decode | 105.334 | 183.183 | 413.851 | 174.592 | 77.874 | 18.908 | 5.134 |
| Large Map encode | 6.773 | 114.816 | 178.072 | 130.441 | 131.483 | 1.752 | 1.744 |
| Large Map decode | 33.024 | 248.173 | 320.931 | 222.208 | 231.520 | 5.306 | 3.930 |
| Deep Nested encode | 47.616 | 78.944 | 171.808 | 85.043 | 74.381 | 4.457 | 2.501 |
| Deep Nested decode | 316.554 | 160.401 | 274.398 | 142.336 | 96.469 | 10.475 | 3.455 |
