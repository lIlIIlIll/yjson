...
Server under
`<local>/yjson-cjfast-20260821-6f2f47c/target/cjfast-full36-rawgeneric-20260821-r1`
...
`<local>/yjson-json-literal-formal-20260820-ni926t/evidence` and in the
...
`<local>/yjson-session-20260817-Codex` and local ignored `target/`
...
remain under `<local>/yjson-adaptive-session-20260817` and ignored local
...
`<local>/yjson-person-hotpath-20260817` and ignored local
...
under `<local>/yjson-borrowed-formal-20260817/evidence` on the Server.
