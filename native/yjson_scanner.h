...
/* Formats one finite Float64 directly into caller-owned output storage. */
int64_t YJ_JSON_FormatFloat64(
    double value, uint8_t* output, int64_t outputCap, int64_t outputOffset);
