...
class DocumentationContractTest(unittest.TestCase):
    ...
    def test_accepts_cjdoc_bound_param_tag(self):
        document = fixture()
        member = document["declarations"][1]
        member["parameters"][0]["documentation"] = None
        member["documentation"]["tags"].insert(
            0, {"name": "param", "subject": "text", "description": "Input JSON."}
        )
        self.check(document)
